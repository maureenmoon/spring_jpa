...
<%@ include file="../include/header.jsp" %>
	...
	<div class="container ">
		...
		<form action="write" method="get">
			...
			<div class="row mb-3 px-3">
				<label for="content" class="col-2 col-form-label">contentID</label> <input
					type="text" id="content" class="col form-control" name="contentID" />
			</div>
			<div class="row mb-3 px-3">
				<label for="title" class="col-2 col-form-label">이미지</label> <input
					type="text" id="title" class="col form-control" name="imageUrl" />
			</div>
			<div class="row mb-3 px-3">
				<label for="content" class="col-2 col-form-label">내용</label> <input
					type="text" id="content" class="col form-control" name="description" />
			</div>
